"""Driver monitoring producer services."""
...
SUBSCRIBED_SIGNALS = CAN_SIGNAL_SERVICE_MAPPINGS["driver_monitoring_services"]


class DriverMonitoringService(DomainSignalService):
    """Publishes driver monitoring and behavior updates to the data broker."""

    def __init__(self, can_gateway: CANGWService, broker: KuksaDataBroker) -> None:
        super().__init__("driver_monitoring_services", SUBSCRIBED_SIGNALS, can_gateway, broker)
